...
export const { addUpdateCart, removeFromCart, clearCart, setCartCategory } = cartSlice.actions;
export const { cartItems, cartCount, cartCategory } = cartSlice.selectors;
export const selectCartItems = (state: { cart: { items: CartItem[] } }) => state.cart.items;
