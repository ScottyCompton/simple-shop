...
const CartSummary: React.FC<CartSummaryProps> = ({
  ...
  return (
    <div className="w-full">
      {items.length === 0 ? (
        <div
          className="p-8 text-center bg-slate-50 rounded-lg shadow-sm"
        ...
        <div className="space-y-4">
          <div
            className="hidden sm:grid grid-cols-12 gap-2 p-3 font-semibold text-gray-700 bg-gray-100 rounded-t-lg"
            style={{
          ...
          <Flex direction="column" className="mt-6 sm:mt-8" justify="end">
            <div
              className="bg-slate-50 p-4 sm:p-6 rounded-lg shadow-sm"
              style={{ backgroundColor: "var(--component-bg)" }}
            >
              ...
              <div
                className="h-px w-full bg-gray-200 my-3"
